...
from dal import *
# from dal import get_customer_quantity_per_order, get_customers_by_credit_limit_range, get_customers_payments_by_lastname_pattern, get_customers_with_shipping_dates, get_employees_with_office_phone, get_first_5_customers, get_orders_with_null_comments, get_payments_total_and_average
